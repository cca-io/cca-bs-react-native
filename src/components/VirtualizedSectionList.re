...
external scrollToEndOptions: (~animated: bool=?, unit) => scrollToEndOptions =
  "";
[@bs.send] external scrollToEnd: ReactDOMRe.domRef => unit = "scrollToEnd";
[@bs.send]
external scrollToEndWithOptions:
  (ReactDOMRe.domRef, scrollToEndOptions) => unit =
  "scrollToEnd";
...
[@bs.send] external recordInteraction: ReactDOMRe.domRef => unit = "";

[@bs.send] external flashScrollIndicators: ReactDOMRe.domRef => unit = "";
